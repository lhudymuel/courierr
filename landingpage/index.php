        ...
        <div class="slider-area">
            <div class="slider" style="background: #494C53;">
                <div id="bg-slider" class="owl-carousel owl-theme" >
                    ...
                    <div class="item"><img src="assets/img/slide1/cover1.jpg" style=" opacity: 0.8;" alt="1"></div> 
                    <div class="item"><img src="assets/img/slide1/cover2.jpg" style=" opacity: 0.8;" alt="2"></div> 
                    <div class="item"><img src="assets/img/slide1/cover3.jpg" style=" opacity: 0.8;" alt="3"></div>   
                        ...
                        <div class="col-md-12 "> 
                            <div class="col-xs-10 page-subheader sorting pl0">
                                ...
                                <div class="items-per-page">
                                    <label for="items_per_page"><b>Other Post</b></label>
