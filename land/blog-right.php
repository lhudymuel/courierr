            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse yamm" id="navigation">
                    <div class="button navbar-right">
                        ...
                        <button class="navbar-btn nav-button wow fadeInRight" onclick=" window.open('submit-about.php')" data-wow-delay="0.5s">Submit</button>
                    </div>
                    <ul class="main-nav nav navbar-nav navbar-right">
                        <li class="dropdown ymm-sw " data-wow-delay="0.1s">
                            ...
                            <ul class="dropdown-menu navbar-nav">
                                ...
                                <li>
                                    <a href="index.php">Home Style 5</a>
                                </li>
                        ...
                        <li class="wow fadeInDown" data-wow-delay="0.1s"><a class="" href="about.php">Property</a></li>
                                    ...
                                    <div class="yamm-content">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-3">
                                                ...
                                                <ul> 
                                                    <li><a href="submit-about.php">Submit - step 1</a> </li>
                                                    <li><a href="submit-about.php">Submit - step 2</a> </li>
                                                    <li><a href="submit-about.php">Submit - step 3</a> </li> 
                                                </ul>
                                                <h5>User account</h5>
                                                <ul>
                                                    <li><a href="register.php">Register / login</a>   </li>
                                                    <li><a href="user-properties.php">Your properties</a>  </li>
                                                    <li><a href="submit-about.php">Submit property</a>  </li>
                ...
                <div class="row">
                    <div class="blog-lst col-md-9">
                        <section class="post">
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <p class="author-category">
                                        ...
                                        in <a href="blog.php">Webdesign</a>
                                    </p>
                                </div>
                                <div class="col-sm-6 right" >
                                    <p class="date-comments">
                                        <a href="single.php"><i class="fa fa-calendar-o"></i> June 20, 2013</a>
                                        <a href="single.php"><i class="fa fa-comment-o"></i> 8 Comments</a>
                                    </p>
                                </div>
                            </div>
                            ...
                            <p class="read-more">
                                <a href="single.php" class="btn btn-default btn-border">Continue reading</a>
                            </p>
                        </section>   
                                ...
                                <div class="panel-body recent-property-widget">
                                        ...
                                        <li>
                                            <div class="col-md-3 col-sm-3 col-xs-3 blg-thumb p0">
                                                <a href="single.php"><img src="assets/img/demo/small-property-2.jpg"></a>
                                        ...
                                        <li>
                                            <div class="col-md-3 col-sm-3  col-xs-3 blg-thumb p0">
                                                <a href="single.php"><img src="assets/img/demo/small-property-1.jpg"></a>
                                                <span class="property-seeker">
                                                    <b class="b-1">A</b>
                                                    <b class="b-2">S</b>
                                                </span>
                                        ...
                                        <li>
                                            <div class="col-md-3 col-sm-3 col-xs-3 blg-thumb p0">
                                                <a href="single.php"><img src="assets/img/demo/small-property-3.jpg"></a>
                                                <span class="property-seeker">
                                                    <b class="b-1">A</b>
                                                    <b class="b-2">S</b>
                                                </span>
                        ...
                        <div class="col-md-3 col-sm-6 wow fadeInRight animated">
                            <div class="single-footer">
                                ...
                                <ul class="footer-menu">
                                    ...
                                    <li><a href="faq.php">fqa</a>  </li> 
                                    <li><a href="faq.php">Terms </a>  </li> 
                                </ul>
                            </div>
                        </div>
                        <div class="col-md-3 col-sm-6 wow fadeInRight animated">
                            <div class="single-footer">
                                ...
                                <ul class="footer-blog">
                                    <li>
                                        ...
                                        <div class="col-md-8  col-sm-8 col-xs-8  blg-entry">
                                            <h6> <a href="single.php">Add news functions </a></h6> 
